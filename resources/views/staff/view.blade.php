...
<div class="body-wrapper">
    ...
    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary" id="headermaster">Master Data Staff
                                    </h6>

                                    <!-- Tombol Tambah Data -->
                                    <a href="{{ url('/staff/create') }}" class="btn btn-primary btn-icon-split btn-sm">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $a->no_telepon }}</td>
                                                    <td>{{ $a->email_staff }}</td>
                                                    <td>{{ $a->kategori_staff }}</td>
                                                    <td>
                                                        <a href="{{ route('staff.edit', $a->id) }}"
        ...
        function deleteConfirm(e) {
            ...
            document.getElementById('deleteForm').setAttribute('action', "{{ url('staff') }}/" + id);
