        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('saldo_awal.store') }}" method="POST">
                        @csrf

                        <!-- Kode Saldo (Readonly) -->
                        <div class="mb-3">
                            <label for="kode_saldo" class="form-label">Kode Saldo</label>
                            <input type="text" class="form-control" id="kode_saldo" name="kode_saldo"
                                value="{{ $kode_saldo }}" readonly>
                        </div>
                        ...
                        <a href="{{ route('saldo_awal.index') }}" class="btn btn-secondary">Batal</a>
                    </form>
