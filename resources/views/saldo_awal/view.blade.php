        ...
        <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary" id="headermaster">Transaksi Saldo Awal
                                        </h6>

                                        <!-- Tombol Tambah Data -->
                                        <a href="{{ url('/saldo_awal/create') }}"
                                                ...
                                                <tbody>
                                                    @foreach ($saldo as $a)
                                                        <tr>
                                                            ...
                                                            <td>{{ ucfirst($a->posisi_db_cr) }}</td>
                                                            <td>
                                                                <a href="{{ route('saldo_awal.edit', $a->id) }}"
            ...
            <script>
                function deleteConfirm(e) {
                    ...
                    document.getElementById('deleteForm').setAttribute('action', "{{ url('saldo_awal') }}/" + id);
