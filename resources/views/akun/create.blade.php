                    ...
                    <form action="{{ route('akun.store') }}" method="post">
                        ...
                        <fieldset disabled>
                            <div class="mb-3"><label for="kodeakunlabel">ID</label>
                                <input class="form-control form-control-solid" id="kode_akun_tampil" name="kode_akun_tampil"
                                    type="text" placeholder="Contoh: KG-1" value="{{ $kodeAkun }}" readonly>
                            </div>
                        </fieldset>
                        <input type="hidden" id="kode_akun" name="kode_akun" value="{{ $kodeAkun }}">
                        ...
                        <div class="mb-3"><label for="namaakunlabel">Nama Akun</label>
                            <input class="form-control form-control-solid" id="nama_akun" name="nama_akun" type="text"
                                placeholder="Cth: Kas" value="{{ old('nama_akun') }}">
                        </div>
                        <div class="mb-3"><label for="headerakunlabel">Header Akun</label>
                            <input class="form-control form-control-solid" id="header_akun" name="header_akun"
                                type="text" placeholder="Cth: 111" value="{{ old('header_akun') }}">
                        </div>
